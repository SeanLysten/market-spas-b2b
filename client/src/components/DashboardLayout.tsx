...
import { LayoutDashboard, LogOut, PanelLeft, Settings, Users, UsersRound, Package, ShoppingCart, FileText, Wrench, BookOpen, MessageSquare, Cog, CalendarDays } from "lucide-react";
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            <h1 className="text-2xl text-display text-display font-semibold tracking-tight text-center">
              Sign in to continue
            </h1>
  ...
  return (
    <>
      <div className="relative" ref={sidebarRef}>
        ...
        <div
          className={`absolute top-0 right-0 w-[3px] h-full cursor-col-resize hover:bg-primary/20 ${isCollapsed ? "hidden" : ""}`}
          onMouseDown={() => {
