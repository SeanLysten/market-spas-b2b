        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <Card>
            <CardContent className="pt-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                  <p className="text-xs md:text-sm text-muted-foreground dark:text-muted-foreground">Leads clients</p>
          ...
          <Card>
            <CardContent className="pt-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                  <p className="text-xs md:text-sm text-muted-foreground dark:text-muted-foreground">Taux de conversion</p>
          ...
          <Card>
            <CardContent className="pt-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                  <p className="text-xs md:text-sm text-muted-foreground dark:text-muted-foreground">Budget dépensé</p>
          ...
          <Card>
            <CardContent className="pt-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                  <p className="text-xs md:text-sm text-muted-foreground dark:text-muted-foreground">Impressions</p>
                          ...
                          >
                            <td className="p-4">
                              <div>
                                ...
                                <p className="text-xs md:text-sm text-muted-foreground dark:text-muted-foreground">{lead.productInterest}</p>
                              </div>
                            </td>
                            <td className="p-4">
                            ...
                            <td className="p-4">
                              <div className="space-y-1">
                                {lead.email && (
                                  <p className="text-xs md:text-sm text-muted-foreground dark:text-muted-foreground flex items-center gap-1">
            ...
            <Tabs value={adsTab} onValueChange={(v) => setAdsTab(v as 'meta' | 'google' | 'analytics')} className="space-y-4">
              <TabsList className="grid w-full max-w-xl grid-cols-3">
                ...
                <TabsTrigger value="analytics">
                  <svg className="w-4 h-4 mr-2" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="24" y="120" width="32" height="48" rx="4" fill="#F9AB00"/>
                    <rect x="80" y="72" width="32" height="96" rx="4" fill="#E37400"/>
            ...
            {showAccountSelector && metaCallbackData && (
              <Card className="border-info/20 dark:border-info/30 bg-info/10 dark:bg-info-light">
                <CardContent className="p-4 md:p-4 md:p-6">
                  ...
                  <p className="text-xs md:text-sm text-muted-foreground dark:text-muted-foreground mb-4">Connecté en tant que <strong>{metaCallbackData.metaUserName}</strong></p>
                    ...
                    {metaCallbackData.adAccounts?.map((acc: any) => (
                      <div key={acc.id} className="flex items-center justify-between p-3 bg-white rounded-lg border">
                        <div>
                          ...
                          <p className="text-xs md:text-sm text-muted-foreground dark:text-muted-foreground">ID: {acc.accountId} | {acc.currency} | {acc.timezone}</p>
                        </div>
                        <Button
                          size="sm"
                          onClick={() => {
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-destructive dark:text-destructive hover:text-destructive dark:text-destructive w-full sm:w-auto"
                        onClick={() => {
                ...
                {dailyInsightsData?.dailyData && dailyInsightsData.dailyData.length > 0 && (
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <div className="flex items-center justify-center gap-4 md:p-6 mt-2 text-xs text-muted-foreground dark:text-muted-foreground">
            ...
            {metaCampaignsData?.connected && !metaLoading && campaigns.length === 0 && !metaCampaignsData?.error && (
              ...
              <TabsContent value="google" className="space-y-4">
                {!googleOAuthUrl?.url ? (
                  <Card className="border-amber-200 bg-amber-500/10 dark:bg-amber-500/20">
                    <CardContent className="p-4 md:p-4 md:p-8">
                        ...
                        <CardContent className="p-4 md:p-4 md:p-6">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <Button variant="outline" size="sm" className="mt-3 w-full sm:w-auto" onClick={() => refetchGoogleCampaigns()}>
              ...
              <TabsContent value="analytics" className="space-y-4">
                <AdminGoogleAnalytics
                  onCallbackHandled={() => {
                    // Nettoyer l'URL après traitement du callback GA4
                    window.history.replaceState({}, "", window.location.pathname);
                  }}
                />
              </TabsContent>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-xs md:text-sm text-muted-foreground dark:text-muted-foreground">{stats.total} leads assignés</p>
                        </div>
